...
<div
	class="absolute inset-y-0 left-0 w-64 p-4 transform -translate-x-full md:relative md:translate-x-0 bg-stone-900 border-r border-stone-800 shadow-xl transition-all"
>
