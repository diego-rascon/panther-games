<script lang="ts">
	...
	import watchRoundOutline from '@iconify/icons-solar/watch-round-outline';
...
>
	<a href="/home" data-sveltekit-preload-data class="btn p-4 rounded-xl"
		><PantherGamesLogo size={2} /></a
	>
